...
def send_anon():
    ...
    """
    return render_template('send_anon.html') # render the create template


@app.route('/send_anon', methods=['POST'])
def send_anon_post():
    """
...
@app.route('/send_signed')
def send_signed():
    """
    Route for GET requests to the create page.
    Displays a form users can fill out to create a new document.
    """
    return render_template('send_signed.html') # render the create template


@app.route('/send_signed', methods=['POST'])
